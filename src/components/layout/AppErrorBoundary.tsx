      ...
      <div className="flex min-h-screen items-center justify-center bg-cream-100 p-6">
        ...
        >
          ...
          <p className="mt-2 text-sm leading-relaxed text-charcoal-500">
            Atronz hit an unexpected error and could not finish loading this
            screen. Your pet data is stored locally and has not been affected.
          </p>
          <button
            type="button"
            onClick={this.handleReload}
            className="mt-5 inline-flex items-center justify-center gap-2 rounded-full bg-sage-600 px-4 py-2.5 text-sm font-medium text-white transition hover:bg-sage-700"
          >
