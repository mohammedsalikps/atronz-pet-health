...
export function Avatar({
  ...
  return (
    <span
      className={cn(
        'relative flex shrink-0 items-center justify-center overflow-hidden bg-sage-100 font-semibold uppercase tracking-wide text-sage-700 ring-1 ring-inset ring-black/5',
        SIZE_CLASSES[size],
        SHAPE_CLASSES[shape],
        className,
      )}
